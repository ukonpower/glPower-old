export default class glPower {
    ...
    setUniform(uni) {
        ...
        switch (type) {
            ...
            case 'tex':
                if(uni.value){
                    if(!uni.value.framebuffer){
                        this.gl.bindTexture(this.gl.TEXTURE_2D, uni.value.texture);
                    }
                    this.gl['uniform1i'](uni.location, uni.value.texUnit);
                }
                break;
            default:
